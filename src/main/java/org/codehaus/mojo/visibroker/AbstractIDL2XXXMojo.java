    ...
    extends AbstractVisiBrokerMojo
{
    ...
    /**
     * Additional java command line string
     * @parameter 
     * @optional
     * 
     */
    protected String javaCommandLineString;
        ...
        throws MojoExecutionException
    {
        ...
        for ( int i = 0; i < this.sources.length; ++i )
        {
            ...
            if (javaCommandLineString != null) {
                cl.createArgument().setValue( javaCommandLineString );
            }
